 ...
 <BODY>
   <div class="container">
       ...
       <div class="card"> 
	     ...
	     <div class="card-body">
		 <form action="update" method="POST" modelAttribute="whUserType">
       
          <div class="row">
		<div class="col-4">
		<label ref="uomid" class="control-label" style="color:red">User ID</label>
		</div>
			<div class="col-6" style="color:blue">
			<input type="text" id="uomid" class="form-control"  name="id" readonly="readonly" />
		</div>
		</div>
